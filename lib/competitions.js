...
async function update_ui() {
    ...
    var games = await get_games_from_matchday(comp, "2022-2023", 1);
...
async function get_matchday() {
    var shedule = await load_shedule();
...
async function load_shedule() {
    let dictionary = await fetch('../spielplaene/bundesliga.json').json();
    return dictionary;
}
