...
async function update_ui() {
    ...
    var c = parent.document.URL.substring(i1, i2);
    console.log(c);

    var matchday = await get_matchday();
...
async function get_matchday() {
    var shedule = await load_schedule();
...
async function load_schedule() {
    let response = await fetch('../spielplaene/bundesliga.json');
