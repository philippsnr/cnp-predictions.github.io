...
function createGameRow(game_id, league, th, res, ta) {
    ...
    if(res == "Prediction"){
        res_div = create_prediction_div(league, game_id);
    }
    else{
...
function create_prediction_div(league, game_id){
    ...
    new_div.setAttribute("onclick", `window.location.href = 'game.html?competition=${league}&gameID=${game_id}'`)
