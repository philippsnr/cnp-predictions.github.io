...
const serviceAccount = require('path/to/your/serviceAccountKey.json'); // Pfad zu Ihrer Service-Kontoschlüssel-Datei

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: 'https://your-firebase-database-url.firebaseio.com' // Ersetzen Sie dies durch Ihre Firebase-Datenbank-URL
});
